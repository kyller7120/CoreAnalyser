...
class BalanceGeneralController extends Controller
{
    ...
    public function crear_excel(Request $request, $periodo_id)
    {
        ...
        return view('vistas.analisis.balance_general_excel',compact('data', 'periodo_id', 'cuentas_a', 'cuentas_d', 'cuenta_p', 'cuentas_pa', 'deudora', 'acredora', 'patrimonio', 'pasivo_patrimonio'));
    }
    ...
    public function crear(Request $request, $periodo_id)
    {
        ...
        // return response()->json($cuenta_p);
        return view('vistas.analisis.balance_general',compact('data', 'periodo_id', 'cuentas_a', 'cuentas_d', 'cuenta_p', 'cuentas_pa', 'deudora', 'acredora', 'patrimonio', 'pasivo_patrimonio'));
    }
